// Package model defines the database models and data structures used by the front-ui panel.
package model
...
// User represents a user account in the front-ui panel.
type User struct {
...
// Setting stores key-value configuration settings for the front-ui panel.
type Setting struct {
	Id    int    `json:"id" form:"id" gorm:"primaryKey;autoIncrement"`
