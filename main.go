// Package main is the entry point for the front-ui web panel application.
...
import (
	...
	"github.com/abasakbari86/front-ui/v2/database"
	"github.com/abasakbari86/front-ui/v2/logger"
	"github.com/abasakbari86/front-ui/v2/sub"
	"github.com/abasakbari86/front-ui/v2/util/crypto"
	"github.com/abasakbari86/front-ui/v2/util/sys"
	"github.com/abasakbari86/front-ui/v2/web"
	"github.com/abasakbari86/front-ui/v2/web/global"
...
// runWebServer initializes and starts the web server for the front-ui panel.
func runWebServer() {
...
// migrateDb performs database migration operations for the front-ui panel.
func migrateDb() {
...
// main is the entry point of the front-ui application.
...
func main() {
	...
	flag.Usage = func() {
		...
		fmt.Println("    migrate        migrate form other/old front-ui")
