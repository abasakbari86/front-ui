// Package entity defines data structures and entities used by the web layer of the front-ui panel.
package entity
...
// AllSetting contains all configuration settings for the front-ui panel including web server, Telegram bot, and subscription settings.
