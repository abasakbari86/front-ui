// Package controller provides HTTP request handlers and controllers for the front-ui web management panel.
...
import (
	...
	"github.com/abasakbari86/front-ui/v2/web/session"
