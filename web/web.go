// Package web provides the main web server implementation for the front-ui panel,
...
import (
	...
	"github.com/abasakbari86/front-ui/v2/config"
	"github.com/abasakbari86/front-ui/v2/logger"
	"github.com/abasakbari86/front-ui/v2/util/common"
	"github.com/abasakbari86/front-ui/v2/web/controller"
	"github.com/abasakbari86/front-ui/v2/web/job"
	"github.com/abasakbari86/front-ui/v2/web/locale"
	"github.com/abasakbari86/front-ui/v2/web/middleware"
	"github.com/abasakbari86/front-ui/v2/web/network"
	"github.com/abasakbari86/front-ui/v2/web/service"
	"github.com/abasakbari86/front-ui/v2/web/websocket"
...
// Server represents the main web server for the front-ui panel with controllers, services, and scheduled jobs.
type Server struct {
	httpServer *http.Server
	listener   net.Listener

	index *controller.IndexController
	panel *controller.FRONTUIController
...
func (s *Server) initRouter() (*gin.Engine, error) {
	...
	engine.Use(sessions.Sessions("front-ui", store))
	...
	// Apply the redirect middleware (`/frontui` to `/panel`)
	engine.Use(middleware.RedirectMiddleware(basePath))

	g := engine.Group(basePath)

	s.index = controller.NewIndexController(g)
	s.panel = controller.NewFRONTUIController(g)
