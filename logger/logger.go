// Package logger provides logging functionality for the front-ui panel with
...
const (
	...
	logFileName      = "frontui.log"         // Log file name
...
func InitLogger(level logging.Level) {
	newLogger := logging.MustGetLogger("front-ui")
	...
	if consoleBackend := initDefaultBackend(); consoleBackend != nil {
		...
		leveledBackend.SetLevel(level, "front-ui")
	...
	if fileBackend := initFileBackend(); fileBackend != nil {
		...
		leveledBackend.SetLevel(logging.DEBUG, "front-ui")
		backends = append(backends, leveledBackend)
	}
